...
export const PAYMENT_LIST = "http://localhost:5000/get-payment-list";
export const ADD_REVIEW = "http://localhost:5000/add-review";
export const GET_REVIEW = "http://localhost:5000/get-review";
